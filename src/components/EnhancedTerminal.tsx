  ...
  return (
    <ErrorBoundary>
      <OptimizedContainer className={`min-h-screen relative ${className}`}>
        {/* Simple buttons to replace floating action buttons */}
        <div className="fixed top-6 right-6 z-40">
          <button 
            onClick={() => setShowAccessibilityPanel(true)}
            className="w-12 h-12 bg-cyan-500 hover:bg-cyan-600 rounded-full text-white flex items-center justify-center transition-colors"
          >
            ⚙️
          </button>
        </div>
        ...
        <div className="fixed bottom-6 right-6 z-40">
          <button 
            ...
            className="w-12 h-12 bg-blue-500 hover:bg-blue-600 rounded-full text-white flex items-center justify-center transition-colors"
          >
            📧
          </button>
        </div>
